...
//				'next' : ['week','month','year']
		...
		{
			return '<div>\
						<span>'+lang('Time')+': <span class="hour-val">00</span> 点</span>\
					</div>\
					<div class="hour">\
					<label><input type="range" class="hour-range" name="hour" min="0" max="23"></label>\
					</div>\
					<div class="minute" style="display:none;">\
